...
const Main = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <>
          <Button className="text-green-500" type="link" onClick={() => handleEditNews(record)}>
            <i className="fa-solid fa-pen-to-square"></i>
          </Button>

          <Button className="text-red-100" type="link" danger onClick={() => handleDeleteNews(record.id)}>
